...
sed -i.ori -e  's/EXT_NET_CIDR=.*/EXT_NET_CIDR='\''192.168.253.0\/24'\''/' \
-e  's/EXT_NET_RANGE=.*/EXT_NET_RANGE='\''start=192.168.253.180,end=192.168.41.199'\''/' \
-e  's/EXT_NET_GATEWAY=.*/EXT_NET_GATEWAY='\''192.168.253.1'\''/' \
 init-runonce
