...
sleep 3
tar zcvf /export/backup/opt110_$DDATE.tgz --exclude=*/nginxlog/* --exclude=*/download/* --exclude=*/mysql/* --exclude=*/mysql_binlog/*  /export/backup/mnt/*
umount /export/backup/mnt
#backup yunwei opt 5
tar zcvf /export/backup/opt5_$DDATE.tgz.tgz --exclude=*/nginxlog/* --exclude=*/download/* --exclude=*/mysql/* --exclude=*/mysql_binlog/*  /opt/*
